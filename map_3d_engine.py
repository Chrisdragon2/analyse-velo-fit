...
# ... (les fonctions check_mapbox_api_key et prepare_segment_data ne changent pas) ...
...
def create_pydeck_chart(df, climb_segments, sprint_segments):
    ...
    TERRAIN_ELEVATION_TILE_URL = f"https://api.mapbox.com/v4/mapbox.terrain-rgb/{{z}}/{{x}}/{{y}}.png?access_token={MAPBOX_KEY}" [cite: 10]
