...
# ... (Toutes vos autres fonctions check_mapbox_api_key et prepare_segment_data restent INCHANGÉES) ...
...
def create_pydeck_chart(df, climb_segments, sprint_segments):
    ...
    # ... (Toute votre logique de préparation de données, couches, et vue reste INCHANGÉE) ...
    ...
    deck = pdk.Deck(
        ...
        # --- VOICI LA VRAIE CORRECTION ---
        
        # 1. Fournit la clé via 'api_keys' (votre code d'origine)
        api_keys={'mapbox': MAPBOX_KEY}, 
        
        # 2. Force le chargement du JavaScript de Mapbox
        map_provider='mapbox',
