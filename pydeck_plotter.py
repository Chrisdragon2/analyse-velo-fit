...
# --- MODIFIÉ : La fonction accepte maintenant 3 arguments ---
def create_pydeck_chart(df, climb_segments, sprint_segments):
    ...
    # Couche 1: Trace Principale (Couleur neutre pour être recouverte)
    path_data_main = [
    ...
    # Couche 1: Trace Principale (Couleur neutre, semi-transparente)
    layer_main = pdk.Layer(
        'PathLayer',
        data=path_data_main,
        pickable=True,
        get_color=[255, 255, 255, 80], # Blanc semi-transparent
        width_scale=1,
