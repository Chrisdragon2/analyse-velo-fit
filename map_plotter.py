...
# Seuil de puissance max pour la couleur noire
PUISSANCE_MAX_ECHELLE = 1000.0 

def create_map_figure(df, mapbox_style="carto-positron"):
    """
    Crée une carte Scattermapbox (Version Lignes colorées par Chunks de 250m)
    """
    ...
    CHUNK_DISTANCE_MAP = 200 # Taille du segment de ligne coloré (en mètres)
